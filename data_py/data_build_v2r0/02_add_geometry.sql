...
alter table spam2005v2r0_value_production alter column cell5m  type numeric(19,5) using cell5m::numeric;
...
SELECT AddGeometryColumn ('spam2005v2r0_value_production','wkb_geometry',4326,'POLYGON',2);
...
CREATE INDEX spam2005v2r0_value_production_geom_idx ON spam2005v2r0_value_production USING GIST (wkb_geometry);
...
CREATE INDEX ON spam2005v2r0_value_production (cell5m);
