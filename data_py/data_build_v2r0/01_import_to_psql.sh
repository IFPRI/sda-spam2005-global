...
mv spam2005v2r0_value-production.csv spam2005v2r0_value-production_latin1.csv
...
iconv -f latin1 -t utf-8 spam2005v2r0_value-production_latin1.csv > spam2005v2r0_value-production.csv
...
sudo -u postgres ogr2ogr -f "PostgreSQL" PG:"user=djuser dbname=djspamdata password=djpass" spam2005v2r0_value-production.csv
...
/Applications/Postgres.app/Contents/Versions/9.3/bin/ogr2ogr -f "PostgreSQL" PG:"user=djuser dbname=djspamdata password=djpass" spam2005v2r0_value-production.csv