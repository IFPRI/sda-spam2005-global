...
for cnt in ['KGZ', 'TKM', 'ALB', 'MKD', 'PRT', 'TUR', 'AZE', 'GRC', 'ARM', 'TJK', 'CYP', 'MEX' , 'CUB', 'HTI', 'DOM', 'JAM', 'PRI', 'BLZ', 'GLP', 'GTM', 'VIR', 'ATG', 'KNA', 'MSR' , 'HND', 'DMA', 'NIC', 'MTQ', 'SLV', 'LCA', 'VCT', 'BRB', 'COL', 'GRD', 'VEN', 'TTO' , 'CRI', 'PAN', 'GUY', 'SUR', 'GUF', 'BRA', 'ECU', 'PER', 'BOL', 'CHL', 'PRY', 'ARG' , 'URY', 'IRN', 'IRQ', 'SYR', 'MLT', 'LBN', 'JOR', 'ISR', 'SAU', 'KWT', 'OMN', 'BHR' , 'QAT', 'ARE', 'YEM', 'TUN', 'DZA', 'MAR', 'LBY', 'EGY', 'KIR', 'PNG', 'SLB', 'AUS' , 'VUT', 'FJI', 'NCL', 'NZL', 'RUS', 'MLI', 'NER', 'TCD', 'SDN', 'MRT', 'ERI', 'SEN' , 'BFA', 'ETH', 'GMB', 'NGA', 'CMR', 'DJI', 'GNB', 'GIN', 'BEN', 'SOM', 'GHA', 'TGO' , 'CAF', 'CIV', 'SLE', 'LBR', 'COD', 'KEN', 'GNQ', 'UGA', 'COG', 'GAB', 'STP', 'TZA' , 'RWA', 'BDI', 'SYC', 'AGO', 'ZMB', 'MWI', 'MUS', 'MOZ', 'MDG', 'ZWE', 'NAM', 'BWA' , 'ZAF', 'SWZ', 'LSO', 'USA']:
	print cnt
